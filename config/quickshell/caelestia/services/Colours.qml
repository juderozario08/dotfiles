...
Singleton {
    ...
    component M3Palette: QtObject {
        ...
        property color m3neutral_paletteKeyColor: "#090a0f"
        property color m3neutral_variant_paletteKeyColor: "#151827"
        property color m3background: "#090a0f"
        property color m3onBackground: "#c0caf5"
        property color m3surface: "#0d0f17"
        property color m3surfaceDim: "#090a0f"
        property color m3surfaceBright: "#161926"
        property color m3surfaceContainerLowest: "#05060a"
        property color m3surfaceContainerLow: "#0c0e16"
        property color m3surfaceContainer: "#10131e"
        property color m3surfaceContainerHigh: "#151827"
        property color m3surfaceContainerHighest: "#1c2033"
        property color m3onSurface: "#c0caf5"
        property color m3surfaceVariant: "#10131e"
        property color m3onSurfaceVariant: "#a9b1d6"
        property color m3inverseSurface: "#c0caf5"
        property color m3inverseOnSurface: "#090a0f"
        property color m3outline: "#2f354f"
        property color m3outlineVariant: "#1a1d2e"
        property color m3shadow: "#000000"
        property color m3scrim: "#000000"
        property color m3surfaceTint: "#7aa2f7"
        property color m3primary: "#7aa2f7"
        property color m3onPrimary: "#090a0f"
        property color m3primaryContainer: "#172347"
        property color m3onPrimaryContainer: "#7aa2f7"
        property color m3inversePrimary: "#5a7fd7"
        property color m3secondary: "#bb9af7"
        property color m3onSecondary: "#090a0f"
        property color m3secondaryContainer: "#261c3b"
        property color m3onSecondaryContainer: "#bb9af7"
        property color m3tertiary: "#7dcfff"
        property color m3onTertiary: "#090a0f"
        property color m3tertiaryContainer: "#0f2a38"
        property color m3onTertiaryContainer: "#7dcfff"
        property color m3error: "#f7768e"
        property color m3onError: "#090a0f"
        property color m3errorContainer: "#38121d"
        property color m3onErrorContainer: "#f7768e"
        property color m3success: "#9ece6a"
        property color m3onSuccess: "#090a0f"
        property color m3successContainer: "#142b1a"
        property color m3onSuccessContainer: "#9ece6a"
        property color m3primaryFixed: "#7aa2f7"
        property color m3primaryFixedDim: "#5a7fd7"
        property color m3onPrimaryFixed: "#090a0f"
        property color m3onPrimaryFixedVariant: "#172347"
        property color m3secondaryFixed: "#bb9af7"
        property color m3secondaryFixedDim: "#9b7ad7"
        property color m3onSecondaryFixed: "#090a0f"
        property color m3onSecondaryFixedVariant: "#261c3b"
        property color m3tertiaryFixed: "#7dcfff"
        property color m3tertiaryFixedDim: "#5db7e8"
        property color m3onTertiaryFixed: "#090a0f"
        property color m3onTertiaryFixedVariant: "#0f2a38"
        property color term0: "#090a0f"
        ...
        property color term7: "#c0caf5"
        property color term8: "#363b54"
