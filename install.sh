...
sudo pacman -S fd ripgrep npm eza zoxide htop tokei tree bat fzf lazygit tmux btop pyenv --noconfirm
...
yay -S gtk3 gtk4 hyprland nautilus pavucontrol pulse qt6ct rofi starship systemd waybar wlogout xsettingsd \
    ...
    zen-browser-bin sddm-sugar-dark mpvpaper --noconfirm
...
for i in $(eza -a ~/dotfiles/config/ || exit); do
